                    ...
                    <div class="h-full w-full flex items-center justify-center rounded border-2 border-black px-1 py-1 bg-[#B5DFCA]">
                        <div class="flex items-center justify-center">
                            <div class="flex flex-col h-72 w-2/5 items-start justify-evenly px-5">
                                ...
                                <p class="text-base font-medium">An Information Systems student at Universitas Indonesia. Currently on my 2nd year. Motivated to create positive impact, learn and explore new experience, earn new ability, improve my capability, broaden my knowledge. I also love manga or light novel reading on my free time.</p>
