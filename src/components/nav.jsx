    ...
    if(!isSmall){
        return(
            <>
                ...
                <div class="hidden fixed h-svh w-full px-8 py-8" >
                    <div class="h-full w-full flex items-center justify-center rounded border-2 border-black py-1 bg-[#A1CDA8]">
                ...
                <nav  className="fixed w-full px-8 py-8" >
                    <div class=" w-full inline-flex justify-between rounded border-2 border-black px-1 py-1 bg-[#A1CDA8]">
        ...
        if(!openedNav){
            return(
                <>
                {/* popped up nav */}
                    <div class="fixed h-svh w-full px-8 py-8" >
                        <div class="h-full w-full flex items-center justify-center rounded  border-2 border-black py-1 bg-[#A1CDA8]">
                            <div class="flex flex-col items-center justify-center w-full"  ref={ref}>
                    ...
                    {/* popped up nav */}
                    <nav  class="fixed  w-full px-8 py-8" >
                        <div class=" w-full inline-flex justify-between rounded border-2 border-black px-1 py-1 bg-[#A1CDA8]">
                            <div class="buttonName">
                                <Namebutton text={"Photic"} link={"#first-container"}></Namebutton>
                            </div>
